...
public class AssistantAdapter extends RecyclerView.Adapter<AssistantAdapter.MyViewHolder> {
    ...
    public AssistantAdapter(List<Message> messageList, Activity activity) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(activity).inflate(R.layout.adapter_assistant, parent, false);
